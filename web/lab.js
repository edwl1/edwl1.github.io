lab1 = () => alert("Hello World1");
lab2 = () => console.log("Hello World!");
lab5 = () => alert("Текст1: " + prompt("Введите текст") + " Ответ: " + confirm("Ответ?"));
lab6_1 = () => {
...
lab10_linear_algorithm_2 = () => {
    a = parseFloat(prompt("число 1"));
    b = parseFloat(prompt("число 2"));
    alert("Площадь: "+(a*b/2)+"\n"+"Периметр: "+(a+b+Math.sqrt(Math.pow(a,2)+Math.pow(b,2))));
}
lab10_linear_algorithm_3 = () => {
